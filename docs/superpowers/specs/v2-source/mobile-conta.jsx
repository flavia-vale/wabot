// CONTA v2 — princípio: lista plana de configurações, linguagem do usuário,
// sem duplicar conteúdo do Espelhar.
//
// Cortado da v1: hero gigante com blob/gradiente marketing, "Saúde da conta"
// com jargão ("Preservação avançada"), seção "Espelhamento" que duplicava a aba.
...
const MobileConta = () => (
  <MobileFrame title="Conta" active="conta">
    {/* Perfil — limpo */}
...
window.MobileConta = MobileConta;
