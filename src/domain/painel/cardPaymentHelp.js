...
export function buildCardPaymentSteps({ accountEmail } = {}) {
  ...
  return [
    ...
    email
      ? `O Mercado Pago só aceita a cobrança automática se você entrar lá com o mesmo e-mail enviado por nós (${email}). Se no Mercado Pago você usa outro e-mail, escreva esse e-mail no campo "Usa outro e-mail no Mercado Pago?" desta página e toque de novo em "Cobrança automática".`
      : 'O Mercado Pago só aceita a cobrança automática se você entrar lá com o mesmo e-mail enviado por nós. Se no Mercado Pago você usa outro e-mail, escreva esse e-mail no campo "Usa outro e-mail no Mercado Pago?" desta página e toque de novo em "Cobrança automática".',
...
export const CARD_HELP_MP_EMAIL_TEXT = 'O Mercado Pago só libera a cobrança automática para quem entra lá com o mesmo e-mail enviado por nós. Se o seu e-mail no Mercado Pago é diferente do da sua conta aqui, escreva ele abaixo antes de tocar em "Cobrança automática". A sua conta aqui não muda.'
