...
export function buildCapacityAlertConditions(snapshot = {}, { now = new Date(), previous = null } = {}) {
  ...
  return [
    ...
    { type: 'collection_stale', breached: ageMinutes > 120, severity: ageMinutes > 180 ? 'critical' : 'attention', observedValues: { ageMinutes: Number.isFinite(ageMinutes) ? Math.round(ageMinutes) : null }, recommendation: 'Restaure a coleta antes de interpretar a capacidade.' },
