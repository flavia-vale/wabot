...
('faq_seed_whatsapp_ban', 'Vou ser banida do WhatsApp?', 'O BOTinho respeita limites de envio, usa intervalos configuráveis e permite filtros anti-spam. Ainda assim, recomendamos operar com grupos autorizados e mensagens relevantes para reduzir riscos.', 1, true),
