...
const testimonials = [
  { q: 'Eu mandava os links na mão para 4 grupos e canais diferentes. Agora durmo e acordo com comissão pingando.', name: 'Sol Almeida', role: 'Afiliada Shopee · 6 grupos/canais', g: 'linear-gradient(135deg,#F4D9E0,#A78BFA)' },
  { q: 'O texto que ele monta soa igual eu falando. As meninas do canal nem percebem que é bot.', name: 'Mariana Costa', role: 'Influencer micro · ML + Amazon', g: 'linear-gradient(135deg,#C8E6D8,#7CC9A9)' },
