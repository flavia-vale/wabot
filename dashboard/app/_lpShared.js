...
export const LP_CONFIG = {
  ...
  'bot-ofertas-infoprodutos-whatsapp': { title: 'Bot de ofertas para infoprodutos no WhatsApp | BOTinho', description: 'Escale ofertas de infoprodutos em grupos com copy orientada a conversão, conferência de link monetizado e distribuição consistente.', uniqueHeadline: 'Infoprodutos: conversão previsível com processo claro.', uniqueBody: 'Em infoprodutos, resultado depende de promessa alinhada, prova, timing e link correto. O BOTinho ajuda a padronizar copy, validar tag/código de afiliado e manter frequência de divulgação sem caos operacional.', uniqueBullets: ['Resposta direta: valide oferta, promessa e link monetizado antes de distribuir.', 'Copywriting com foco em dor, transformação e CTA objetivo.', 'Automação com cadência controlada para preservar qualidade e contexto dos grupos.'], faq: [{ q: 'Como reduzir perda de comissão em campanhas de infoprodutos?', a: 'Revise no celular se o link final mantém tag/código de afiliado após redirecionamentos e se o destino corresponde à oferta prometida.' }, { q: 'Essa página promete integração oficial com plataformas de infoproduto?', a: 'Não. O foco é processo operacional de divulgação e conferência, sem promessa de integração não aprovada.' }], howTo: ['Selecione ofertas com promessa clara, prova e prazo comercial válidos.', 'Confirme o link monetizado com tag/código de afiliado ativo e destino correto.', 'Publique com copy curta e segmentada por grupo, e use logs para otimizar a próxima rotina.'] },
  'bot-ofertas-cursos-whatsapp': { title: 'Bot de ofertas para cursos no WhatsApp | BOTinho', description: 'Escale campanhas de cursos em grupos de WhatsApp com copy persuasiva, conferência de link monetizado e distribuição previsível.', uniqueHeadline: 'Cursos: mais matrículas com rotina, não com improviso.', uniqueBody: 'No nicho de cursos, a conversão depende de clareza de benefício, urgência real e link correto. O BOTinho ajuda a padronizar copy, validar tag de afiliado e distribuir para grupos compatíveis com cadência controlada.', uniqueBullets: ['Resposta direta: confira oferta e link de afiliado antes de escalar.', 'Copywriting de conversão: dor, transformação, prova e CTA objetivo.', 'Distribuição em grupos segmentados para aumentar relevância e reduzir ruído.'], faq: [{ q: 'Como evitar perder comissão em campanhas de cursos?', a: 'Antes de divulgar, valide no celular se o link final mantém tag/código de afiliado e aponta para a página correta do curso.' }, { q: 'A página promete integração oficial com plataformas de curso?', a: 'Não. O foco é no processo de operação e divulgação: curadoria, conferência e distribuição, sem prometer integração não aprovada.' }], howTo: ['Escolha ofertas de cursos com proposta clara, preço e prazo de inscrição válidos.', 'Confira o link monetizado, incluindo redirecionamento e tag/código de afiliado ativo.', 'Distribua com copy curta e CTA específico por grupo, depois revise logs para otimizar a próxima campanha.'] },
  'bot-ofertas-autopecas-whatsapp': { title: 'Bot de ofertas para autopeças no WhatsApp | BOTinho', description: 'Acelere campanhas de autopeças em grupos de WhatsApp com copy padronizada, conferência de link e distribuição previsível.', uniqueHeadline: 'Autopeças: menos improviso, mais giro de oferta.', uniqueBody: 'No nicho de autopeças, oportunidade tem janela curta e margem sensível. Com um processo claro, você revisa link monetizado, padroniza a copy e distribui para os grupos certos sem depender de operação manual repetitiva.', uniqueBullets: ['Resposta direta: valide oferta + link monetizado antes de escalar.', 'Copywriting orientado a conversão: benefício, condição, prazo e CTA objetivo.', 'Distribuição com cadência controlada para reduzir ruído e preservar qualidade do grupo.'], faq: [{ q: 'Como evitar perder comissão por link errado em autopeças?', a: 'Antes de publicar, abra o link no celular e confirme se tag/código de afiliado permanece após redirecionamentos e se o destino final está correto.' }, { q: 'Esse fluxo promete integração oficial com marketplaces de autopeças?', a: 'Não. A proposta é operacional: curadoria, conferência de link e distribuição. Sem prometer integração não aprovada.' }], howTo: ['Escolha ofertas com preço, disponibilidade e prazo de validade conferidos.', 'Revise o link monetizado e confirme que a comissão está atribuível (tag/código ativo).', 'Publique com copy curta e clara, depois distribua por grupos segmentados e acompanhe os logs.'] },
  'bot-ofertas-turismo-whatsapp': { title: 'Bot de ofertas para turismo no WhatsApp | BOTinho', description: 'Organize campanhas de turismo em grupos de WhatsApp com rotina de curadoria, conferência de link e distribuição consistente.', uniqueHeadline: 'Turismo: timing promocional com operação previsível.', uniqueBody: 'Ofertas de turismo mudam rápido por data, disponibilidade e condição comercial. O BOTinho ajuda a padronizar revisão de link monetizado e distribuir mensagens com cadência para reduzir erro operacional.', uniqueBullets: ['Rotina para ofertas sazonais e janelas promocionais curtas.', 'Conferência de link monetizado/tag de afiliado antes da distribuição.', 'Automação com controle de frequência para evitar sobrecarga nos grupos.'], faq: [{ q: 'Posso automatizar sem revisar condições da oferta?', a: 'Não. A prática recomendada é validar preço, regras, disponibilidade e link de afiliado antes de ativar a distribuição.' }, { q: 'Esse fluxo promete integração direta com plataformas de turismo?', a: 'Não. O conteúdo aborda processo operacional de divulgação e conferência, sem prometer integração não aprovada.' }], howTo: ['Selecione ofertas de turismo com condições e prazo válidos.', 'Valide no celular se o link final preserva tag/código de afiliado e destino correto.', 'Distribua para grupos compatíveis e acompanhe logs para ajustes de cadência e qualidade.'] },
  'bot-ofertas-pet-shop-whatsapp': { title: 'Bot de ofertas para pet shop no WhatsApp | BOTinho', description: 'Escale ofertas de pet shop em grupos do WhatsApp com rotina padronizada de curadoria, conferência de link e distribuição.', uniqueHeadline: 'Pet shop: constância de ofertas sem caos operacional.', uniqueBody: 'No nicho pet, a recorrência de compra favorece operações consistentes. O BOTinho ajuda a validar oferta, manter padrão de copy e distribuir com cadência responsável em grupos segmentados.', uniqueBullets: ['Rotina de ofertas por categoria (ração, higiene, acessórios).', 'Conferência prévia de link monetizado/tag de afiliado para reduzir perda de comissão.', 'Distribuição com frequência controlada para preservar qualidade dos grupos.'], faq: [{ q: 'O bot substitui validação de oferta e link?', a: 'Não. A recomendação é validar oferta, estoque, cupom e link monetizado antes de automatizar a distribuição.' }, { q: 'Posso usar para afiliados de pet shop sem integração específica?', a: 'Sim. O fluxo foca no processo operacional (curadoria, conferência e distribuição), sem prometer integração não aprovada com plataformas externas.' }], howTo: ['Selecione ofertas pet com preço, estoque e prazo válidos.', 'Confira se o link final mantém tag/código de afiliado e destino correto no celular.', 'Distribua para grupos compatíveis e monitore logs para ajustar cadência e desempenho.'] },
  'bot-ofertas-afiliados-whatsapp': { title: 'Bot de ofertas para afiliados no WhatsApp | BOTinho', description: 'Escalone divulgação de links monetizados em grupos com processo claro de conferência e distribuição.', uniqueHeadline: 'Afiliados: escala com proteção de comissão.', uniqueBody: 'No nicho de afiliados, um link errado pode custar comissão. O BOTinho apoia a rotina de conferência, padronização de copy e distribuição em grupos com consistência operacional.', uniqueBullets: ['Conferência de tag/código de afiliado antes de divulgar.', 'Padronização de mensagens para reduzir erros de operação.', 'Distribuição em grupos com intervalo e rastreio para evitar retrabalho.'], faq: [{ q: 'O bot garante comissão do afiliado?', a: 'Não. A comissão depende das regras da plataforma e da configuração correta do link monetizado. O bot ajuda a organizar o processo de conferência e distribuição.' }, { q: 'Posso usar em diferentes programas de afiliado?', a: 'Sim. A página foca no processo operacional de validar link, copy e grupos, sem prometer integração específica não aprovada.' }], howTo: ['Valide destino final e tag/código do link de afiliado no celular.', 'Padronize a copy da oferta com preço, prazo e CTA claro.', 'Distribua para grupos compatíveis e revise logs para corrigir falhas rapidamente.'] },

  'bot-ofertas-beleza-whatsapp': { title: 'Bot de ofertas para beleza no WhatsApp | BOTinho', description: 'Acelere campanhas de beleza no WhatsApp com processos de distribuição em escala.', uniqueHeadline: 'Beleza: operação contínua para campanhas de alta recorrência.', uniqueBody: 'Produtos de beleza pedem constância e timing promocional. O BOTinho automatiza a rotina para manter presença e conversão.', uniqueBullets: ['Rotina de divulgação para skincare, make e haircare.', 'Padronização de mensagens para aumentar confiança.', 'Escala com menos esforço no dia a dia.'], faq: [{ q: 'Como começar rápido no nicho beleza?', a: 'Comece com poucos grupos, valide resposta e amplie com dados.' }, { q: 'Como medir ROI inicial?', a: 'Acompanhe cliques, comissão e frequência por categoria.' }], howTo: ['Crie trilhas por categoria de beleza.', 'Ative distribuição para grupos com maior engajamento.', 'Ajuste ofertas por sazonalidade e campanhas temáticas.'] },

  'automatizar-divulgacao-em-grupos-whatsapp': { lpType: 'pain', title: 'Automatizar divulgação em grupos WhatsApp | BOTinho', description: 'Resolva o gargalo de divulgar manualmente em grupos do WhatsApp com uma rotina automatizada e controlada.', uniqueHeadline: 'Diagnóstico: divulgação manual trava escala.', uniqueBody: 'Quando cada campanha depende de copiar, colar e conferir grupo por grupo, a operação perde velocidade. O BOTinho transforma a divulgação em um fluxo repetível com origem, destino e cadência definidos.', uniqueBullets: ['Menos tempo gasto em tarefas repetitivas.', 'Mais previsibilidade na publicação de ofertas.', 'Métrica esperada: redução do tempo operacional por campanha.'], faq: [{ q: 'Como automatizar divulgação em grupos sem perder controle?', a: 'Mapeie fontes e destinos, defina regras de intervalo e acompanhe logs para ajustar a operação.' }, { q: 'Preciso mudar minha rotina inteira?', a: 'Não. Comece com uma campanha recorrente, valide o fluxo e expanda gradualmente.' }], howTo: ['Diagnostique quais grupos consomem mais tempo manual.', 'Configure origem, destino e intervalo de publicação no BOTinho.', 'Acompanhe logs e ajuste a cadência conforme resposta do público.'] },
  'escalar-grupos-ofertas-sem-equipe': { lpType: 'pain', title: 'Escalar grupos de ofertas sem equipe | BOTinho', description: 'Escale grupos de ofertas no WhatsApp sem contratar equipe adicional para tarefas repetitivas.', uniqueHeadline: 'Diagnóstico: crescimento sem processo vira gargalo.', uniqueBody: 'Mais grupos não precisam significar mais pessoas copiando links. Com o BOTinho, a operação ganha processo para multiplicar distribuição mantendo controle de cadência.', uniqueBullets: ['Aumente cobertura sem ampliar equipe manual.', 'Padronize o fluxo de postagem entre grupos.', 'Métrica esperada: mais grupos ativos por operador.'], faq: [{ q: 'Dá para escalar com uma pessoa só?', a: 'Sim. A automação permite começar com operação enxuta e ampliar grupos por etapas.' }, { q: 'Como evitar bagunça ao crescer?', a: 'Separe grupos por prioridade, nicho e frequência antes de ativar novas rotinas.' }], howTo: ['Liste os grupos que já performam melhor.', 'Crie conjuntos de destino por prioridade operacional.', 'Ative novas rotinas aos poucos e acompanhe produtividade por operador.'] },
  'postar-em-varios-grupos-whatsapp-ao-mesmo-tempo': { lpType: 'pain', title: 'Postar em vários grupos WhatsApp ao mesmo tempo | BOTinho', description: 'Organize postagens em vários grupos do WhatsApp com automação, intervalos e rastreio de envios.', uniqueHeadline: 'Diagnóstico: postar em massa sem regra gera risco e falha.', uniqueBody: 'O objetivo não é disparar sem controle, e sim publicar com sequência, intervalo e registro. O BOTinho ajuda a transformar múltiplos grupos em uma rotina rastreável.', uniqueBullets: ['Controle intervalos entre envios para reduzir repetição.', 'Evite esquecer grupos importantes.', 'Métrica esperada: aumento da cobertura com menos falhas.'], faq: [{ q: 'O bot envia tudo de uma vez?', a: 'A operação pode usar intervalos e regras para manter uma cadência mais segura e organizada.' }, { q: 'Consigo ver onde já foi postado?', a: 'Sim. Os logs ajudam a acompanhar envios e detectar falhas de rotina.' }], howTo: ['Agrupe os destinos por prioridade e tipo de público.', 'Defina intervalo e ordem de publicação.', 'Revise logs para confirmar cobertura e ajustar exceções.'] },
  'padronizar-divulgacao-afiliado-whatsapp': { lpType: 'pain', title: 'Padronizar divulgação de afiliado no WhatsApp | BOTinho', description: 'Padronize a divulgação de links de afiliado no WhatsApp com mensagens consistentes e fluxo operacional.', uniqueHeadline: 'Diagnóstico: cada postagem diferente reduz controle.', uniqueBody: 'Afiliados ganham escala quando têm padrão de mensagem, horário e destino. O BOTinho ajuda a manter a mesma régua operacional sem depender de edição manual em cada grupo.', uniqueBullets: ['Copy mais consistente por campanha.', 'Menos variação manual entre grupos.', 'Métrica esperada: melhora na leitura de CTR por categoria.'], faq: [{ q: 'Como padronizar sem parecer robótico?', a: 'Use modelos base, segmentação por grupo e ajustes por categoria de oferta.' }, { q: 'Serve para várias redes de afiliado?', a: 'Sim. O foco da LP é o processo de divulgação, independentemente da origem da oferta.' }], howTo: ['Defina modelos de mensagem por tipo de oferta.', 'Separe destinos por público e categoria.', 'Use logs para comparar desempenho entre padrões de divulgação.'] },
  'aumentar-conversao-em-grupos-de-cupons': { lpType: 'pain', title: 'Aumentar conversão em grupos de cupons | BOTinho', description: 'Aumente a conversão em grupos de cupons com consistência de postagem, timing e organização operacional.', uniqueHeadline: 'Diagnóstico: conversão cai quando timing falha.', uniqueBody: 'Cupom bom precisa chegar na hora certa e para o grupo certo. O BOTinho reduz atraso operacional e ajuda a manter frequência para capturar oportunidades de compra.', uniqueBullets: ['Mais velocidade em cupons com validade curta.', 'Segmentação por interesse ou ticket.', 'Métrica esperada: melhora de clique por oferta publicada.'], faq: [{ q: 'Automação melhora conversão sozinha?', a: 'Ela melhora consistência e timing; a conversão também depende da oferta, copy e público.' }, { q: 'Como medir evolução?', a: 'Compare cliques, horários e categorias antes e depois da rotina automatizada.' }], howTo: ['Identifique categorias de cupom com maior resposta.', 'Configure grupos de destino por interesse.', 'Ajuste horários e cadência com base nos logs de envio.'] },
  'consistencia-postagens-em-grupos': { lpType: 'pain', title: 'Consistência de postagens em grupos | BOTinho', description: 'Mantenha consistência de postagens em grupos do WhatsApp sem depender de lembretes manuais.', uniqueHeadline: 'Diagnóstico: consistência quebra quando depende de memória.', uniqueBody: 'A operação perde força quando publica muito em um dia e some no outro. O BOTinho ajuda a criar uma cadência previsível para manter presença sem sobrecarga.', uniqueBullets: ['Rotina de publicação mais estável.', 'Menos campanhas esquecidas em horários importantes.', 'Métrica esperada: aumento de dias com postagem ativa.'], faq: [{ q: 'Como manter consistência sem virar spam?', a: 'Defina intervalos, limite por grupo e priorize campanhas realmente relevantes.' }, { q: 'Dá para ajustar por dia da semana?', a: 'Sim. A operação pode evoluir conforme horários e dias de melhor resposta.' }], howTo: ['Mapeie dias e horários críticos da operação.', 'Crie uma cadência inicial por grupo de destino.', 'Revise a frequência semanal e ajuste o volume de postagens.'] },
  'reduzir-tempo-operacional-em-grupos-whatsapp': { lpType: 'pain', title: 'Reduzir tempo operacional em grupos WhatsApp | BOTinho', description: 'Reduza o tempo operacional gasto com grupos do WhatsApp automatizando tarefas repetitivas de divulgação.', uniqueHeadline: 'Diagnóstico: tempo operacional invisível consome margem.', uniqueBody: 'Minutos repetidos em cada grupo viram horas por semana. O BOTinho centraliza o fluxo de espelhamento para que a equipe foque em oferta, copy e análise.', uniqueBullets: ['Menos copia-e-cola entre grupos.', 'Mais tempo para curadoria e estratégia.', 'Métrica esperada: horas economizadas por semana.'], faq: [{ q: 'Como calcular o tempo economizado?', a: 'Compare o tempo médio por campanha manual com o tempo de revisão após automatizar o fluxo.' }, { q: 'Preciso parar de revisar as mensagens?', a: 'Não. A automação reduz execução repetitiva, mas a revisão estratégica continua importante.' }], howTo: ['Meça quanto tempo uma campanha manual consome.', 'Automatize primeiro a rotina mais repetitiva.', 'Compare horas economizadas e reinvista em otimização de ofertas.'] },
  'organizar-calendario-de-ofertas-no-whatsapp': { lpType: 'pain', title: 'Organizar calendário de ofertas no WhatsApp | BOTinho', description: 'Organize calendário de ofertas no WhatsApp com rotina, segmentação e acompanhamento de campanhas.', uniqueHeadline: 'Diagnóstico: calendário sem execução vira intenção.', uniqueBody: 'Ter datas promocionais mapeadas não basta se a publicação falha. O BOTinho ajuda a transformar calendário em distribuição consistente para grupos prioritários.', uniqueBullets: ['Campanhas recorrentes por categoria e data.', 'Menos improviso em sazonalidades importantes.', 'Métrica esperada: maior cumprimento do calendário planejado.'], faq: [{ q: 'Como organizar o calendário de ofertas?', a: 'Separe datas, categorias, grupos e cadência de postagem antes de ativar a rotina.' }, { q: 'Funciona para campanhas sazonais?', a: 'Sim. Datas promocionais podem ter regras e destinos específicos.' }], howTo: ['Liste datas e categorias prioritárias do mês.', 'Defina grupos e mensagens por campanha.', 'Acompanhe execução e ajuste o calendário com base nos resultados.'] },
  'melhorar-alcance-em-grupos-de-promocoes': { lpType: 'pain', title: 'Melhorar alcance em grupos de promoções | BOTinho', description: 'Melhore o alcance em grupos de promoções com distribuição consistente, segmentada e rastreável.', uniqueHeadline: 'Diagnóstico: alcance falha quando a oferta não chega em todos os destinos.', uniqueBody: 'Alcance em grupos depende de cobertura, horário e relevância. O BOTinho ajuda a reduzir falhas de distribuição e manter presença nos destinos certos.', uniqueBullets: ['Mais cobertura nos grupos prioritários.', 'Segmentação para reduzir mensagens irrelevantes.', 'Métrica esperada: aumento de grupos cobertos por campanha.'], faq: [{ q: 'Mais alcance significa postar mais?', a: 'Não necessariamente. O foco é cobrir melhor os grupos certos com cadência controlada.' }, { q: 'Como evitar queda de qualidade?', a: 'Use filtros, segmentação e revisão de desempenho por grupo.' }], howTo: ['Identifique grupos com maior potencial de alcance.', 'Organize destinos por prioridade e perfil.', 'Acompanhe cobertura por campanha e refine a segmentação.'] },
  'rastrear-resultados-de-divulgacao-em-grupos': { lpType: 'pain', title: 'Rastrear resultados de divulgação em grupos | BOTinho', description: 'Rastreie resultados da divulgação em grupos com logs, consistência de campanha e leitura operacional.', uniqueHeadline: 'Diagnóstico: sem rastreio, otimização vira chute.', uniqueBody: 'Quando a equipe não sabe o que foi enviado, onde e quando, fica difícil melhorar. O BOTinho registra a execução para apoiar análise de rotina e performance.', uniqueBullets: ['Logs para conferir envios por campanha.', 'Base para comparar horários e categorias.', 'Métrica esperada: mais clareza sobre campanhas ativas.'], faq: [{ q: 'Quais resultados devo acompanhar primeiro?', a: 'Comece por envio concluído, grupo de destino, horário, cliques e comissão quando disponível.' }, { q: 'O rastreio substitui análise manual?', a: 'Não. Ele organiza a base para que a análise manual seja mais rápida e confiável.' }], howTo: ['Defina quais eventos importam para sua rotina.', 'Use logs para validar envio e cobertura.', 'Compare resultados por campanha e ajuste prioridades.'] },
}
