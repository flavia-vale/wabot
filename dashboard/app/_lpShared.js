...
export const LP_CONFIG = {
  ...
  'postar-em-varios-grupos-whatsapp-ao-mesmo-tempo': { lpType: 'pain', title: 'Postar em vários grupos e/ou canais WhatsApp ao mesmo tempo', description: 'Organize postagens em vários grupos e/ou canais do WhatsApp com automação, intervalos e rastreio de envios.', uniqueHeadline: 'Diagnóstico: postar em massa sem regra gera risco e falha.', uniqueBody: 'O objetivo não é disparar sem controle, e sim publicar com sequência, intervalo e registro. O BOTinho ajuda a transformar múltiplos grupos e/ou canais em uma rotina rastreável.', uniqueBullets: ['Controle intervalos entre envios para reduzir repetição.', 'Evite esquecer grupos importantes.', 'Métrica esperada: aumento da cobertura com menos falhas.'], faq: [{ q: 'O bot envia tudo de uma vez?', a: 'A operação pode usar intervalos e regras para manter uma cadência mais segura e organizada.' }, { q: 'Consigo ver onde já foi postado?', a: 'Sim. Os logs ajudam a acompanhar envios e detectar falhas de rotina.' }], howTo: ['Agrupe os destinos por prioridade e tipo de público.', 'Defina intervalo e ordem de publicação.', 'Revise logs para confirmar cobertura e ajustar exceções.'] },
