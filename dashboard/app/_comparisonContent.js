...
export const COMPARISON_PAGES = {
  ...
  '/alternativas/proafiliados': {
    ...
    rows: [
      ...
      { key: 'telegram', label: 'Telegram', produto: 'Só WhatsApp (grupos, canais e comunidades).', concorrente: 'ProAfiliados: WhatsApp e Telegram.', reading: 'Se parte da sua audiência está no Telegram, o BOTinho não atende.' },
    ],
  ...
  '/alternativas/shozap': {
    ...
    rows: [
      ...
      { key: 'conexoes', label: 'Conexões de WhatsApp', produto: 'Uma sessão por conta.', concorrente: 'Shozap: 1 no Básico, 3 no Intermediário, 6 no Elite, 15 no Avançado.', reading: 'Se você opera vários números, o Shozap resolve isso de forma direta e o BOTinho não.' },
      ...
      { key: 'recursos-extra', label: 'Recursos que o BOTinho não tem', produto: 'Sem equivalente.', concorrente: 'Shozap: créditos de IA por mês e créditos de SMS a partir do Intermediário.', reading: 'Se SMS faz parte da sua operação, isso não tem equivalente aqui.' },
    ],
  ...
  '/alternativas/fluxopromo': {
    ...
    rows: [
      ...
      { key: 'lojas', label: 'Lojas cobertas', produto: 'Shopee, Amazon, Mercado Livre e Magalu em todos os planos.', concorrente: 'FluxoPromo: 3 no grátis, 4 no Essencial, 5 no Pro e 12 no Expert (R$ 197/mês).', reading: 'O Expert cobre mais lojas do que o BOTinho. Custa R$ 197/mês.' },
      { key: 'telegram', label: 'Telegram', produto: 'Não atende Telegram.', concorrente: 'FluxoPromo: é o destino principal, presente desde o plano grátis.', reading: 'Se o seu canal é no Telegram, o BOTinho não serve.' },
    ],
