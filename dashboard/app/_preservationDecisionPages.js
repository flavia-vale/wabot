...
export const PRESERVATION_DECISION_PAGES = {
  '/bot-comum-vs-botinho': {
    ...
    title: 'Bot comum vs Espelha Grupos: qual preserva melhor sua operação no WhatsApp?',
    ...
    comparison: {
      columns: ['Critério', 'Bot comum', 'Espelha Grupos'],
      rows: [
  ...
  '/protecao-antiban-botinho': {
    ...
    faqs: [
      ...
      { q: 'O Espelha Grupos aplica essas camadas sozinho?', a: 'Ele cuida do que é mecânico: intervalo entre envios, variação de texto, limite por destino e histórico do que saiu. As camadas 3 e 5 dependem de você — só você decide em quais grupos divulgar e prepara o plano B.' },
