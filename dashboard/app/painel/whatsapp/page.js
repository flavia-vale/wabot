    ...
    <div className="pnl-grid" style={{ maxWidth: 560, margin: '0 auto' }}>
      ...
      {pairingCode && !isConnected && (
        <section className="pnl-card" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
          ...
          <p style={{ fontSize: 36, fontFamily: "'JetBrains Mono', ui-monospace, monospace", fontWeight: 700, letterSpacing: '0.2em', color: 'var(--accent-strong)' }} aria-label={`Código: ${pairingCode.split('').join(' ')}`}>{pairingCode}</p>
