 ...
 *
 * Divisão Basic/PRO (2026-09-23): grupos e rótulos seguem o protótipo aprovado
 * pela dona do produto — Divulgar → Automatizar → Configurar → Conta. Itens com
 * `pro: true` aparecem com cadeado para quem não tem o PRO (PainelShell) e
 * abrem a tela explicando o recurso; nunca somem do menu. Telas que não
 * estavam no protótipo (Enviar agora, Tutorial, Preservação, Afiliados)
 * continuam onde a jornada as pede.
 *
