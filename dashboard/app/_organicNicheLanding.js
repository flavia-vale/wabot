...
const pages = {
  'bot-ofertas-restaurantes-whatsapp': {
    ...
    bullets: [
      ...
      'Distribuição em grupos e canais com intervalo para evitar repetição excessiva.',
    ],
    ...
    affiliateBox: null,
    internalLinks: [
      { href: '/automatizar-divulgacao-em-grupos-whatsapp', label: 'Automatizar divulgação em grupos e canais WhatsApp' },
      { href: '/organizar-calendario-de-ofertas-no-whatsapp', label: 'Organizar calendário de ofertas' },
      { href: '/melhorar-alcance-em-grupos-de-promocoes', label: 'Melhorar alcance em grupos e canais de promoções' },
  ...
  'bot-ofertas-marketplace-whatsapp': {
    ...
    process: [
      ...
      'Distribuir nos grupos e/ou canais certos com intervalo e contexto, sem prometer integração não aprovada com marketplaces.',
      'Acompanhar logs e resultados para ajustar categorias, horários e grupos/canais prioritários.',
    ],
    affiliateBox: {
