...
function ActionAlertBanner({ users, onFilterSelect }) {
  ...
  return (
    <section className={`rounded-2xl p-4 ring-1 ${hasCritical ? 'bg-red-50 ring-red-200' : 'bg-emerald-50 ring-emerald-200'}`}>
