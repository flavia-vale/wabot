...
export const PRESERVATION_BLOG_POSTS = {
  ...
  'shadowban-whatsapp-canais': {
    ...
    faq: [
      ...
      { q: 'O Espelha Grupos detecta shadowban?', a: 'Não. Ele não mede alcance, visualização nem cliques do canal. O que ele mostra é o lado do envio: o que saiu, quando e o que falhou. No plano Pro, cada canal ganha um status de saúde calculado pelas falhas de envio, e o canal que recusa envios 3 vezes seguidas é pausado sozinho por 1 hora. Para alcance, compare os cliques no seu link de afiliada e use uma conta-sentinela.' },
  ...
  'bot-whatsapp-antiban-existe': {
    ...
    sections: [
      ...
      { h2: 'O que ela não faz', paragraphs: ['Não mede alcance, visualizações nem cliques do canal e não recupera um número banido. A única pausa automática é a do canal que recusa envios 3 vezes seguidas: ele fica parado por 1 hora (plano Pro), e o status de saúde de cada canal vem das falhas de envio. Queda de alcance você acompanha e reduzir o volume é decisão sua; a ferramenta controla o ritmo do que sai.'] },
