// WhatsApp-style chat mockup — original visual, pastel-friendly, not a 1:1 copy of WhatsApp brand
const waStyles = {
  phone: {
    width: 300,
  ...
  monitorDot: { width: 6, height: 6, borderRadius:'50%', background:'#E55', boxShadow:'0 0 0 4px rgba(238,85,85,0.2)', animation:'pulse 1.6s infinite' },
};

// Group #1 — origem (grupo monitorado, alheio)
const OrigemPhone = () => (
...
// Group #2 — destino (grupo do afiliado, com link convertido)
const DestinoPhone = () => (
