const howStyles = {
  ...
  num: {
    ...
    fontSize: 64, lineHeight: 1, color:'var(--accent-strong)',
    marginBottom: 24,
  },
    ...
    },
    {
      ...
      visual: (
        <div style={howStyles.visual}>
          ...
          <div style={{color:'var(--ink)', marginTop: 6, textDecoration:'line-through', opacity:.5}}>shopee.com.br/...?aff=outraPessoa</div>
          ...
          <div style={howStyles.inner}>
            <div style={howStyles.head}>
              <div>
                ...
                <h2 style={howStyles.h2}>Três passos.<br/><span className="serif" style={{fontStyle:'italic'}}>Zero esforço diário.</span></h2>
              </div>
