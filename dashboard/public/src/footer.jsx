...
const FinalCTA = () => (
  <section data-screen-label="08 CTA Final">
    <div className="wrap">
      <div style={footStyles.cta}>
        <div style={footStyles.blob('var(--accent-strong)', {k:'left', v:'-10%'}, {k:'top', v:'-30%'}, 480)}/>
        <div style={footStyles.blob('var(--accent-2)', {k:'right', v:'-10%'}, {k:'bottom', v:'-40%'}, 420)}/>
        <div style={{position:'relative', zIndex: 1}}>
          ...
          <h2 style={{...footStyles.h2, marginTop: 16}}>Sua próxima venda<br/><span className="serif" style={{fontStyle:'italic'}}>já está no grupo.</span></h2>
          <p style={footStyles.sub}>Conecta o WhatsApp em 4 minutos. Sem cartão, sem letrinha miúda. Se não converter para você, é só desconectar.</p>
          <div style={{display:'flex', gap: 12, justifyContent:'center', flexWrap:'wrap'}}>
            ...
            <a className="btn" href="#" style={{background:'transparent', color:'var(--surface)', border:'1px solid rgba(255,255,255,0.2)'}}>Falar com vendas</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="wrap">
      <div style={footStyles.footGrid}>
        <div>
          ...
          <p style={footStyles.brand}>Bot de WhatsApp que transforma os links dos seus grupos em comissões de afiliada — automaticamente, 24h por dia.</p>
        </div>
        <div>
          <div style={footStyles.colTitle}>Produto</div>
          <a style={footStyles.colLink} href="#como">Como funciona</a>
          <a style={footStyles.colLink} href="#features">Recursos</a>
          <a style={footStyles.colLink} href="#planos">Planos</a>
          <a style={footStyles.colLink} href="#faq">Perguntas</a>
        </div>
        <div>
          <div style={footStyles.colTitle}>Empresa</div>
          <a style={footStyles.colLink} href="#">Sobre</a>
          <a style={footStyles.colLink} href="#">Blog</a>
          <a style={footStyles.colLink} href="#">Contato</a>
          <a style={footStyles.colLink} href="#">Afiliados (do bot)</a>
        </div>
        <div>
          <div style={footStyles.colTitle}>Legal</div>
          <a style={footStyles.colLink} href="#">Termos</a>
          <a style={footStyles.colLink} href="#">Privacidade</a>
          <a style={footStyles.colLink} href="#">LGPD</a>
        </div>
      </div>
