...
const COMPETITORS = [
  ...
  },
  {
    slug: 'gigi-bot',
    name: 'Gigi Bot',
    positioning: 'Bot de afiliados para WhatsApp com conversão automática de links para Shopee, Mercado Livre, Magalu, AliExpress, Kabum, Terabyte, Natura, Shein e Temu.',
    bestFor: 'Quem quer testar de graça e evoluir aos poucos: o plano gratuito já converte links de 9 lojas diferentes.',
    notIdealFor: 'Quem precisa de espelhamento de grupos ou envio automático para WhatsApp/Telegram — só aparecem no plano mais caro.',
    pricingTiers: [
      { name: 'Guru das Promoções Bot', price: 'Grátis', notes: 'Conversão automática de links de 9 lojas, texto de disparo customizável por loja, template de story, limite de 120 promoções/dia.' },
      { name: 'Guru Plus Bot', price: 'R$ 19,99/mês', notes: 'Versão em nuvem 24/7, 5x mais rápido que a versão gratuita, promoções ilimitadas, CTAs de venda personalizados.' },
      { name: 'Gigi Promo Bot', price: 'R$ 39,99/mês', notes: 'Adiciona Amazon, site de promoções com domínio próprio, modo de copiar ofertas de outros afiliados.' },
      { name: 'Gigi Prime Bot', price: 'R$ 49,90/mês (1º mês; de R$67,99)', notes: 'Indicado como "mais popular". 4 filas de envio (até 20 grupos cada), espelhamento de grupos, agendamento por horário, relatório de comissões da Shopee.' },
    ],
    strengths: ['Cobre a maior variedade de lojas entre os concorrentes mapeados: Shopee, Mercado Livre, Magalu, AliExpress, Kabum, Terabyte, Natura, Shein e Temu', 'Plano gratuito já converte link automaticamente, sem exigir cartão', 'Relatório de comissões da Shopee é recurso próprio, não visto nos demais concorrentes mapeados'],
    weaknesses: ['Espelhamento de grupos e envio automático WhatsApp/Telegram só no plano mais caro (Gigi Prime Bot)', 'Amazon só entra a partir do 3º plano pago (Gigi Promo Bot)', 'Preço do Gigi Prime Bot é mostrado como promocional (de R$67,99 para R$49,90) sem indicar se o desconto é permanente'],
    migrationNotes: 'Se o objetivo é espelhar grupos (não só converter link avulso), o plano necessário é o mais caro, Gigi Prime Bot — comparar o custo total com concorrentes que já incluem espelhamento em planos mais baratos.',
    updatedAt: '2026-07-31',
    verifiedAt: '2026-07-31',
    source: 'Print da página de preços em gigibot.com.br, enviado pela usuária em 31/07/2026.',
  },
  {
