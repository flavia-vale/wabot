...
export const CONTENT_SEO_ROUTES = [
  ...
  { path: '/blog/como-ser-afiliado-shopee-whatsapp', title: 'Como ser afiliado Shopee e divulgar ofertas no WhatsApp', description: 'Passo a passo para se tornar afiliado Shopee, gerar seu link de afiliado e divulgar ofertas no WhatsApp com conversão automática e cadência responsável.', template: 'article', priority: 0.8, changeFrequency: 'weekly', lastModified: resolveLastModified('/blog/como-ser-afiliado-shopee-whatsapp'), indexable: true },
  { path: '/blog/como-divulgar-ofertas-amazon-whatsapp', title: 'Como divulgar ofertas da Amazon no WhatsApp como afiliado', description: 'Aprenda a divulgar ofertas da Amazon no WhatsApp como afiliado: tag de associado, link convertido, preview com imagem e cadência que protege seu número.', template: 'article', priority: 0.8, changeFrequency: 'weekly', lastModified: resolveLastModified('/blog/como-divulgar-ofertas-amazon-whatsapp'), indexable: true },
  { path: '/blog/como-divulgar-ofertas-mercado-livre-whatsapp', title: 'Como divulgar ofertas do Mercado Livre no WhatsApp como afiliado', description: 'Passo a passo para divulgar ofertas do Mercado Livre no WhatsApp como afiliado: link de afiliado, conversão automática, preview com imagem e cadência que protege o número.', template: 'article', priority: 0.8, changeFrequency: 'weekly', lastModified: resolveLastModified('/blog/como-divulgar-ofertas-mercado-livre-whatsapp'), indexable: true },
  ...
  { path: '/blog/amazon-shopee-ou-mercado-livre-para-afiliados-whatsapp', title: 'Amazon, Shopee ou Mercado Livre: qual programa de afiliados usar no WhatsApp?', description: 'Compare Amazon, Shopee e Mercado Livre para afiliados que divulgam no WhatsApp: comissão, conversão de link, cupom e como combinar os três programas.', template: 'article', priority: 0.8, changeFrequency: 'weekly', lastModified: resolveLastModified('/blog/amazon-shopee-ou-mercado-livre-para-afiliados-whatsapp'), indexable: true },
