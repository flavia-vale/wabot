...
export const CONTENT_SEO_ROUTES = [
  { path: '/precos', title: 'Preços e planos: quanto custa o robô de ofertas para WhatsApp', description: 'Quanto custa automatizar a divulgação de ofertas de afiliado no WhatsApp: teste 7 dias grátis sem cartão, Basic a partir de R$39 e Pro com canais e ofertas automáticas. Sem fidelidade.', template: 'pricing', priority: 0.95, changeFrequency: 'weekly', lastModified: resolveLastModified('/precos', '2026-08-05'), indexable: true },
