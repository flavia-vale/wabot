...
- Destino com os limites desligados que passa ao fixo "ligado" (decisão da dona do produto, 2026-09-23: **recomeça do padrão, não reaplica o valor antigo**): ao ligar, o destino passa a usar o intervalo mínimo e o limite diário **padrão do sistema** (o mesmo valor que qualquer destino novo, sem preset, recebe hoje), não o valor que porventura estivesse gravado nesse destino de quando os limites foram desligados — esse valor antigo pode estar desatualizado e não é reaplicado às cegas. É consequência direta do fixo "ligado", sempre no sentido de mais seguro; a fase de plano mede quantos destinos estão nesse caso.
...
| Liga/desliga dos limites do destino, por destino/modelo | ligado | **ligado** | está ligado (coincide com o fixo) | está desligado → passa a ligado, e o intervalo mínimo e o limite diário desse destino **recomeçam do padrão do sistema** (não reaplicam o valor antigo gravado — decisão da dona do produto, 2026-09-23) |
